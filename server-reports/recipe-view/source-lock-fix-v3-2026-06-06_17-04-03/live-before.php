...
function dcv5_supported_recipe_codes() {
    if (function_exists('dcv12_batch01_recipe_registry')) {
        $codes = array_keys(dcv12_batch01_recipe_registry());
    } else {
        $codes = ['HR-SL-001', 'HR-SL-007', 'HR-SL-020'];
    }

    return apply_filters('dcv5_supported_recipe_codes', $codes);
}
...
function dcv5_get_recipe_profile($post_id, $code = '') {
    ...
    $profile = apply_filters('dcv5_recipe_profile', $profile, $post_id, $code);
