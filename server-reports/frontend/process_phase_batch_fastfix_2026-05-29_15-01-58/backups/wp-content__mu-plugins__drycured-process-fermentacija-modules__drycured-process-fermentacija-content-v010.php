    ...
    <section id="dcpf-fermentacija" class="dcpf-wrap" aria-label="Fermentacija u proizvodnji trajnih kobasica i salama">
        ...
        <section class="dcpf-hero-panel">
            ...
            <div class="dcpf-dashboard" aria-label="Tipični parametri fermentacije">
                ...
                <figure class="dcpf-dashboard-image">
                    <img src="<?php echo esc_url(home_url('/wp-content/uploads/drycured/home-process/process-07-fermentacija.webp')); ?>" alt="Fermentacija trajnih kobasica u kontroliranoj mikroklimi" loading="eager" decoding="async">
                </figure>
...
function dcpf_append_to_page($content) {
    ...
    $added = true;
    return do_shortcode('[drycured_process_fermentacija]');
}
