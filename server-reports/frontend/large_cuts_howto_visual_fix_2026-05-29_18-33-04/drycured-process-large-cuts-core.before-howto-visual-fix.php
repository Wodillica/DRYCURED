...
function dclc_parent_enhancer(): void {
    ...
    <script id="drycured-large-cuts-parent-enhancer-js">
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (mainPage && typesBlock && !document.querySelector('.dcpovk-howto-guide')) {
                const howto = document.createElement('section');
                howto.className = 'dcpovk-howto-guide';
                howto.innerHTML = `
                    <span class="dcpovk-howto-guide__kicker">Kako koristiti ove vodiče</span>
                    <h2>Prvo procijeni komad, tek onda biraj postupak</h2>
                    <p>Veći komadi se ne pripremaju po osjećaju. Prije soljenja trebaš znati što držiš pred sobom: tanak ili debeo komad, s kožom ili bez kože, s kosti ili bez kosti, masniji ili mršaviji.</p>

                    <div class="dcpovk-howto-guide__grid">
                        <article>
                            <strong>1. Debljina</strong>
                            <span>Tanji komadi se brže sole, ali se lako presuše. Deblji komadi traže dulje soljenje i mirnije izjednačavanje.</span>
                        </article>
                        <article>
                            <strong>2. Kost, koža i masnoća</strong>
                            <span>Kost povećava potrebu za pažljivim pregledom, koža i mast usporavaju sušenje, a mršavi komadi brže gube vlagu.</span>
                        </article>
                        <article>
                            <strong>3. Dimljeno ili bez dima</strong>
                            <span>Kontinentalni pristupi češće koriste hladni dim, a mediteranski se više oslanjaju na sol, zrak i dugo zrenje.</span>
                        </article>
                        <article>
                            <strong>4. Brzina sušenja</strong>
                            <span>Prebrz početak može zatvoriti površinu dok jezgra ostaje preslabo stabilizirana. Kod velikih komada žurba je najskuplji začin.</span>
                        </article>
                    </div>
                `;

                typesBlock.insertAdjacentElement('beforebegin', howto);
            }
