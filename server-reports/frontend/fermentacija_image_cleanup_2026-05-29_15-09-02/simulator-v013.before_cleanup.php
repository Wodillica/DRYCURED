...
function dcpfs_assets() {
    ...
    <style>
        ...
        /* Stable hero image: CSS-based, survives JS innerHTML rewrites */
        .dcpf-dashboard,
        ...
        .dcpf-dashboard::before {
            ...
            height: 220px;
            border-radius: 24px;
            background-image: url("https://drycured.com/wp-content/uploads/drycured/home-process/process-07-fermentacija.webp");
