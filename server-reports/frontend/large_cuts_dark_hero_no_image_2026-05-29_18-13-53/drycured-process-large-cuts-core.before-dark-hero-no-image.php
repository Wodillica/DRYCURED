...
function dclc_render_hero_visual(string $slug): string {
    ...
    ob_start();
    ?>
    <figure class="dclc-hero__image dclc-hero__image--diagram dclc-hero__image--<?php echo esc_attr($data['shape']); ?>">
        <div class="dclc-cut-visual" aria-hidden="true">
            <div class="dclc-cut-visual__board">
                <div class="dclc-cut-shape dclc-cut-shape--<?php echo esc_attr($data['shape']); ?>"></div>
                <span class="dclc-marker dclc-marker--a"></span>
                <span class="dclc-marker dclc-marker--b"></span>
                <span class="dclc-marker dclc-marker--c"></span>
            </div>

            <div class="dclc-cut-visual__legend">
