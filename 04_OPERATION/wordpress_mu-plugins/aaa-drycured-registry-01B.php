...
function drycured_01B_registry_entries() {
    return [
        ...
        'HR-TU-003' => ['order' => 132, 'title' => 'Velikogoričke kobasice', 'family' => 'kobasica', 'slug' => 'hr-tu-003-velikogoricke-kobasice', 'region' => 'Turopolje'],
...
if (!function_exists('dcv12_batch01_recipe_registry')) {
    function dcv12_batch01_recipe_registry() {
        ...
        'HR-LI-002' => ['order' => 111, 'title' => 'Lička kastradina', 'family' => 'kastradina', 'slug' => 'hr-li-002-licka-kastradina', 'region' => 'Lika'],
            'HR-PR-002' => ['order' => 301, 'title' => 'Primorske kobasice', 'family' => 'kobasica', 'slug' => 'hr-pr-002-primorske-kobasice', 'region' => 'Hrvatsko primorje'],
        'HR-PR-001' => ['order' => 300, 'title' => 'Primorska domaća kobasica', 'family' => 'kobasica', 'slug' => 'hr-pr-001-primorska-domaca-kobasica', 'region' => 'Hrvatsko primorje'],
            'HR-CE-002' => ['order' => 401, 'title' => 'Šestinske kobasice', 'family' => 'kobasica', 'slug' => 'hr-ce-002-sestinske-kobasice', 'region' => 'Zagreb i okolica'],
        'HR-CE-003' => ['order' => 402, 'title' => 'Gračanske kobasice', 'family' => 'kobasica', 'slug' => 'hr-ce-003-gracanske-kobasice', 'region' => 'Zagreb i okolica'],
