...
if (!function_exists('dcv12_batch01_recipe_registry')) {
    function dcv12_batch01_recipe_registry() {
        ...
        'HR-SL-039' => ['order' => 33, 'title' => 'Ilocka domaca kobasica', 'family' => 'kobasica', 'slug' => 'hr-sl-039-ilocka-domaca-kobasica', 'region' => 'Srijem (Ilok)'],
            ...
            'HR-SL-046' => ['order' => 40, 'title' => 'Salaske kobasice', 'family' => 'kobasica', 'slug' => 'hr-sl-046-salaske-kobasice', 'region' => 'Slavonija, Baranja i Srijem'],
        ...
        'HR-LI-002' => ['order' => 111, 'title' => 'Licka kastradina', 'family' => 'kastradina', 'slug' => 'hr-li-002-licka-kastradina', 'region' => 'Lika'],
            'HR-PR-002' => ['order' => 301, 'title' => 'Primorske kobasice', 'family' => 'kobasica', 'slug' => 'hr-pr-002-primorske-kobasice', 'region' => 'Hrvatsko primorje'],
        'HR-PR-001' => ['order' => 300, 'title' => 'Primorska domaca kobasica', 'family' => 'kobasica', 'slug' => 'hr-pr-001-primorska-domaca-kobasica', 'region' => 'Hrvatsko primorje'],
            'HR-CE-002' => ['order' => 401, 'title' => 'Sestinske kobasice', 'family' => 'kobasica', 'slug' => 'hr-ce-002-sestinske-kobasice', 'region' => 'Zagreb i okolica'],
        'HR-CE-003' => ['order' => 402, 'title' => 'Gracanske kobasice', 'family' => 'kobasica', 'slug' => 'hr-ce-003-gracanske-kobasice', 'region' => 'Zagreb i okolica'],
        'HR-CE-004' => ['order' => 403, 'title' => 'Zagrebacke krvavice', 'family' => 'krvavica', 'slug' => 'hr-ce-004-zagrebacke-krvavice', 'region' => 'Zagreb i okolica'],
        'HR-CE-005' => ['order' => 404, 'title' => 'Domace tlacenice', 'family' => 'tlacenica_svargl', 'slug' => 'hr-ce-005-domace-tlacenice', 'region' => 'Središnja Hrvatska'],
        'HR-CE-006' => ['order' => 405, 'title' => 'Domace jetrenjace', 'family' => 'iznutrice', 'slug' => 'hr-ce-006-domace-jetrenjace', 'region' => 'Središnja Hrvatska'],
