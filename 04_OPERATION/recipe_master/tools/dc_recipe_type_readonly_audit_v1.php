 ...
 *
 * Namjena:
 * - Čita postojeće dry_recipe postove.
 * - Klasificira recepte prema tehnološkom tipu.
 * - Prepoznaje blokade prije javnog ažuriranja.
 * - Sprema CSV, JSON i MD izvještaje.
 *
 * Stroga zabrana:
 * - Nema WordPress meta upisa.
 * - Nema izmjene postojećih objava.
 * - Nema stvaranja novih objava.
 * - Nema brisanja zapisa.
...
foreach ($ids as $post_id) {
    ...
    // Prioritet: riba i termička obrada smiju nadjačati generički kobasični signal.
