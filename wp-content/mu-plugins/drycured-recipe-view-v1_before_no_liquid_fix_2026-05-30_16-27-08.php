...
if (!function_exists('dcv12_profile_from_post')) {
    function dcv12_profile_from_post($post_id, $code) {
        ...
        $liquids = !empty($quant['liquids']) ? $quant['liquids'] : [
            ['name'=>'Češnjak / tekućina / omotači','amount'=>'PROVJERITI','percent'=>'','rate'=>'','note'=>'Recept ne smije u javnu objavu dok se ne dopune podaci o češnjaku, tekućini ili omotaču.'],
        ];
