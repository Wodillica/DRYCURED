...
if (!function_exists('dcv12_apply_final_profile_overrides')) {
    function dcv12_apply_final_profile_overrides($profile, $code) {
        ...
        if ($code === 'HR-SL-006') {
            $rum_note = 'Srijemska tradicija — rum se dodaje u maloj količini kao aromatska tekućina. Ne prikazuje se kao začin u gramima.';
            ...
            $profile['spices'] = $clean_spices;
            $profile['liquids'] = $clean_liquids;
        }
