...
function dcv5_get_recipe_profile($post_id, $code = '') {
    ...
    if (function_exists('dcv12_profile_from_post')) {
        return dcv12_profile_from_post($post_id, $code);
    }
...
if (!function_exists('dcv12_profile_from_post')) {
    function dcv12_profile_from_post($post_id, $code) {
        ...
        return [
            ...
            'materials' => [
                ['name'=>'Glavne sirovine prema receptu','amount'=>'10,000 kg / prema komadu','percent'=>'','rate'=>'','note'=>'Sastav je preuzet iz kanonskog recepta. Detaljne količine ostaju vezane uz receptni zapis i kalkulator.'],
            ],
            'spices' => [
                ['name'=>'Sol i začini prema receptu','amount'=>'prema receptu','percent'=>'','rate'=>'','note'=>'Začine ravnomjerno rasporediti. Točne količine čuvaju se u kanonskom receptnom profilu.'],
            ],
            'liquids' => [
                ['name'=>'Češnjak, tekućine i omotači','amount'=>'prema receptu','percent'=>'','rate'=>'','note'=>'Ako se koristi češnjakova tekućina, u smjesu ide samo procijeđena tekućina. Omotače pripremiti prema receptu.'],
            ],
